...
const t: Record<string, Entry> = {
  ...
  books_pdf_unavailable: {
    en: "PDF books can't be opened in this preview (Expo Go / web). Use the full Hidayah app build to read them.",
    bn: 'এই প্রিভিউতে (Expo Go / ওয়েব) PDF বই খোলা যায় না। পড়তে Hidayah অ্যাপের পূর্ণ বিল্ড ব্যবহার করুন।',
    ur: 'اس پریویو (Expo Go / ویب) میں PDF کتابیں نہیں کھل سکتیں۔ پڑھنے کے لیے Hidayah ایپ کا مکمل بلڈ استعمال کریں۔',
    tr: "PDF kitaplar bu önizlemede (Expo Go / web) açılamaz. Okumak için Hidayah uygulamasının tam sürümünü kullanın.",
    id: 'Buku PDF tidak dapat dibuka di pratinjau ini (Expo Go / web). Gunakan build lengkap aplikasi Hidayah untuk membacanya.',
  },
  books_file_error: {
  ...
  duas_last_synced: { en: 'Updated', bn: 'হালনাগাদ', ur: 'اپ ڈیٹ', tr: 'Güncellendi', id: 'Diperbarui' },
  duas_sync_interval: { en: 'syncs every {days} days', bn: 'প্রতি {days} দিনে সিঙ্ক হয়', ur: 'ہر {days} دن میں سنک ہوتا ہے', tr: 'her {days} günde bir eşitlenir', id: 'sinkron setiap {days} hari' },
  duas_not_synced: { en: 'Showing built-in copy — will update when online', bn: 'বিল্ট-ইন কপি দেখানো হচ্ছে — অনলাইনে হালনাগাদ হবে', ur: 'بلٹ ان کاپی دکھائی جا رہی ہے — آن لائن ہونے پر اپ ڈیٹ ہوگی', tr: 'Yerleşik kopya gösteriliyor — çevrimiçi olunca güncellenir', id: 'Menampilkan salinan bawaan — akan diperbarui saat online' },

  // ── Masjids ──────────────────────────────────────────────────────────────────
  more_masjids: { en: 'Masjids', bn: 'মসজিদ', ur: 'مساجد', tr: 'Camiler', id: 'Masjid' },
  more_masjids_sub: { en: 'Nearby masjids & jamah times', bn: 'কাছের মসজিদ ও জামাতের সময়', ur: 'قریبی مساجد اور جماعت کے اوقات', tr: 'Yakındaki camiler ve cemaat vakitleri', id: 'Masjid terdekat & waktu jamaah' },
  ...
  masjids_searching_near: { en: 'Searching near', bn: 'অনুসন্ধান হচ্ছে', ur: 'کے قریب تلاش', tr: 'Yakınında aranıyor', id: 'Mencari di dekat' },
  masjids_search_placeholder: { en: 'Search masjid name or area…', bn: 'মসজিদের নাম বা এলাকা খুঁজুন…', ur: 'مسجد کا نام یا علاقہ تلاش کریں…', tr: 'Cami adı veya bölge ara…', id: 'Cari nama masjid atau area…' },
  masjids_add: { en: 'Add masjid', bn: 'মসজিদ যোগ করুন', ur: 'مسجد شامل کریں', tr: 'Cami ekle', id: 'Tambah masjid' },
  masjids_none_nearby: { en: 'No masjids in this radius yet. Try a larger radius, or be the first to add one.', bn: 'এই সীমার মধ্যে এখনো কোনো মসজিদ নেই। বড় সীমা চেষ্টা করুন, অথবা প্রথম হয়ে একটি যোগ করুন।', ur: 'اس دائرے میں ابھی کوئی مسجد نہیں۔ بڑا دائرہ آزمائیں، یا پہلے شخص بنیں جو ایک شامل کرے۔', tr: 'Bu mesafede henüz cami yok. Daha geniş bir mesafe deneyin veya ilk ekleyen siz olun.', id: 'Belum ada masjid dalam radius ini. Coba radius lebih besar, atau jadilah yang pertama menambahkannya.' },
  ...
  masjids_geo_error: { en: 'Location unavailable — showing results around your saved location.', bn: 'অবস্থান পাওয়া যায়নি — সংরক্ষিত অবস্থানের আশেপাশের ফলাফল দেখানো হচ্ছে।', ur: 'مقام دستیاب نہیں — محفوظ شدہ مقام کے ارد گرد نتائج دکھائے جا رہے ہیں۔', tr: 'Konum alınamadı — kayıtlı konumunuzun çevresi gösteriliyor.', id: 'Lokasi tidak tersedia — menampilkan hasil di sekitar lokasi tersimpan.' },
  ...
  masjid_no_jamah: { en: 'No jamah times added yet.', bn: 'এখনো জামাতের সময় যোগ করা হয়নি।', ur: 'ابھی تک جماعت کے اوقات شامل نہیں کیے گئے۔', tr: 'Henüz cemaat vakti eklenmedi.', id: 'Belum ada waktu jamaah.' },
  ...
  masjid_jamah_hint: { en: 'Enter times as HH:MM (24-hour). Leave blank to clear.', bn: 'HH:MM (২৪-ঘণ্টা) হিসেবে সময় লিখুন। মুছতে ফাঁকা রাখুন।', ur: 'اوقات HH:MM (24 گھنٹے) میں درج کریں۔ صاف کرنے کے لیے خالی چھوڑ دیں۔', tr: 'Saatleri SS:DD (24 saat) olarak girin. Temizlemek için boş bırakın.', id: 'Masukkan waktu sebagai HH:MM (24 jam). Kosongkan untuk menghapus.' },
  masjid_jamah_invalid: { en: 'Please enter times as HH:MM, e.g. 05:15 or 13:30.', bn: 'অনুগ্রহ করে HH:MM হিসেবে সময় লিখুন, যেমন 05:15 বা 13:30।', ur: 'براہ کرم اوقات HH:MM میں درج کریں، مثلاً 05:15 یا 13:30۔', tr: 'Lütfen saatleri SS:DD olarak girin, örn. 05:15 veya 13:30.', id: 'Masukkan waktu sebagai HH:MM, mis. 05:15 atau 13:30.' },
  ...
  masjid_adhan_note: { en: "Adhan times are calculated for this masjid's location with your selected method.", bn: 'আযানের সময় আপনার নির্বাচিত পদ্ধতিতে এই মসজিদের অবস্থানের জন্য গণনা করা।', ur: 'اذان کے اوقات آپ کے منتخب کردہ طریقہ سے اس مسجد کے مقام کے لیے شمار کیے گئے ہیں۔', tr: 'Ezan vakitleri, seçtiğiniz yöntemle bu caminin konumu için hesaplanmıştır.', id: 'Waktu adzan dihitung untuk lokasi masjid ini dengan metode yang Anda pilih.' },

  masjid_new_title: { en: 'Add a Masjid', bn: 'মসজিদ যোগ করুন', ur: 'مسجد شامل کریں', tr: 'Cami Ekle', id: 'Tambah Masjid' },
  masjid_new_subtitle: { en: 'Stand at the masjid and tap "Use my location" for the most accurate pin.', bn: 'সবচেয়ে সঠিক অবস্থানের জন্য মসজিদে দাঁড়িয়ে "আমার অবস্থান ব্যবহার করুন" ট্যাপ করুন।', ur: 'سب سے درست مقام کے لیے مسجد میں کھڑے ہو کر "میرا مقام استعمال کریں" پر ٹیپ کریں۔', tr: 'En doğru konum için camide durup "Konumumu kullan"a dokunun.', id: 'Berdirilah di masjid dan ketuk "Gunakan lokasi saya" untuk pin yang paling akurat.' },
  masjid_field_name: { en: 'Masjid name', bn: 'মসজিদের নাম', ur: 'مسجد کا نام', tr: 'Cami adı', id: 'Nama masjid' },
  masjid_field_name_bn: { en: 'Name in Bangla (optional)', bn: 'বাংলায় নাম (ঐচ্ছিক)', ur: 'بنگالی میں نام (اختیاری)', tr: 'Bengalce adı (isteğe bağlı)', id: 'Nama dalam bahasa Bengali (opsional)' },
  ...
  masjid_coords_hint: { en: 'Or enter coordinates manually', bn: 'অথবা স্থানাঙ্ক লিখুন', ur: 'یا محل وقوع دستی طور پر درج کریں', tr: 'Veya koordinatları elle girin', id: 'Atau masukkan koordinat secara manual' },
  masjid_coords_required: { en: 'Please set the masjid location first.', bn: 'অনুগ্রহ করে প্রথমে মসজিদের অবস্থান নির্ধারণ করুন।', ur: 'براہ کرم پہلے مسجد کا مقام متعین کریں۔', tr: 'Lütfen önce caminin konumunu belirleyin.', id: 'Silakan tentukan lokasi masjid terlebih dahulu.' },
  masjid_name_required: { en: 'Please enter the masjid name.', bn: 'অনুগ্রহ করে মসজিদের নাম লিখুন।', ur: 'براہ کرم مسجد کا نام درج کریں۔', tr: 'Lütfen cami adını girin.', id: 'Silakan masukkan nama masjid.' },
  masjid_jamah_optional: { en: 'Jamah times (optional)', bn: 'জামাতের সময় (ঐচ্ছিক)', ur: 'جماعت کے اوقات (اختیاری)', tr: 'Cemaat vakitleri (isteğe bağlı)', id: 'Waktu jamaah (opsional)' },
